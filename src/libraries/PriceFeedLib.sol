 ...
 * If a price is stale, functions will revert, and render the  Solvancy Station unusable - this is by design.
 * We want the Solvancy Station to freeze if prices become stale.
 *
